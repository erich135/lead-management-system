                ...
                {isEditingUser ? (
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="rounded-lg border border-gray-200 p-3 space-y-2">
                      <label className="block text-sm font-semibold text-ars-body">Appointment WhatsApp number</label>
                      {selectedUser.cellPhone ? (
                        <p className="text-xs text-ars-body">Cell phone on this user profile is used when this person is the linked rep.</p>
                      ) : (
